...
class GameInfo:
    ...
    def __init__(self):
        self.TitleId: str = "1AB103"
        self.SecretKey: str = "7DDFII659YNJNOWIDNYXH8367ZCWAXC97898E98DII4K4HO1XC"
        self.ApiKey: str = "OC|9997557843679297|4216c87d2d09ab1c7ff0677b59171559"
...
def titled_data():
    return jsonify({"MOTD": "<color=blue>WELCOME TO OLD TAGGZ</color>\n\n<color=orange>UPDATE: CHRISTMAS 23 FLASHBACK, HAVE AN UPDATE THAT YOU WANT? REQUEST IT IN THE DISCORD!</color>\n\n<color=blue>DISCORD: https://discord.gg/Y6ZSBTZAcj</color>\n\n<color=red>CREDITS: FATE AND DEATH</color>"})
